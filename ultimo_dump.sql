...
CREATE TABLE IF NOT EXISTS "alumno_alumno" (
	...
	"carrera_id"	integer,
	FOREIGN KEY("carrera_id") REFERENCES "alumno_carrera"("id") DEFERRABLE INITIALLY DEFERRED,
...
CREATE TABLE IF NOT EXISTS "alumno_carrera" (
	...
	FOREIGN KEY("departamento_id") REFERENCES "alumno_departamento"("id") DEFERRABLE INITIALLY DEFERRED
);
...
CREATE TABLE IF NOT EXISTS "alumno_pasantia" (
	...
	"entrevista_id"	integer NOT NULL UNIQUE,
...
CREATE TABLE IF NOT EXISTS "alumno_subcomisioncarrera" (
	"id"	integer NOT NULL PRIMARY KEY AUTOINCREMENT,
	"carrera_id"	integer NOT NULL UNIQUE,
	"user_id"	integer NOT NULL UNIQUE,
	FOREIGN KEY("user_id") REFERENCES "alumno_user"("id") DEFERRABLE INITIALLY DEFERRED,
	FOREIGN KEY("carrera_id") REFERENCES "alumno_carrera"("id") DEFERRABLE INITIALLY DEFERRED
);
...
INSERT INTO "alumno_alumno" VALUES (1,3024212,'curriculums/curriculum-gaston-zini-Becas_Onix_UNViMe.pdf','planes_de_estudio/plan-gaston-zini-Becas_Onix_UNViMe.pdf','historias_academicas/historia-gaston-zini-Becas_Onix_UNViMe.pdf','','','2019-08-04',NULL,NULL,'','',0,'','',0,2,NULL);
INSERT INTO "alumno_alumno" VALUES (2,3025017,'curriculums/curriculum-gabriel-hernan-aballay-curriculum.pdf','planes_de_estudio/plan-gabriel-hernan-aballay-plan_de_estudio.pdf','historias_academicas/historia-gabriel-hernan-aballay-historia_academica.pdf','','','2019-08-11',NULL,NULL,'','',0,'','perfiles/perfil-gabriel-hernan-aballay-perfil.jpeg',0,7,1);
INSERT INTO "alumno_alumno" VALUES (3,3003212,'curriculums/curriculum-nicolas-abatedaga-biole-curriculum.pdf','planes_de_estudio/plan-nicolas-abatedaga-biole-plan_de_estudio.pdf','historias_academicas/historia-nicolas-abatedaga-biole-historia_academica.pdf','Interesado en lenguaje html','Manejo fluido de lenguajes de programación básica','2019-08-11',NULL,NULL,'','',0,'','perfiles/perfil-nicolas-abatedaga-biole-perfil.jpeg',0,8,3);
INSERT INTO "alumno_alumno" VALUES (4,3008617,'curriculums/curriculum-tomas-abatedaga-biole-curriculum.pdf','planes_de_estudio/plan-tomas-abatedaga-biole-plan_de_estudio.pdf','historias_academicas/historia-tomas-abatedaga-biole-historia_academica.pdf','','','2019-08-11',NULL,NULL,'','',0,'','',0,9,4);
INSERT INTO "alumno_alumno" VALUES (5,3008610,'curriculums/curriculum-maria-aylen-abraham-curriculum.pdf','planes_de_estudio/plan-maria-aylen-abraham-plan_de_estudio.pdf','historias_academicas/historia-maria-aylen-abraham-historia_academica.pdf','','','2016-08-11',NULL,NULL,'','',0,'','',0,10,5);
INSERT INTO "alumno_alumno" VALUES (6,3055517,'curriculums/curriculum-ezequiel-alessandro-acevedo-curriculum.pdf','planes_de_estudio/plan-ezequiel-alessandro-acevedo-plan_de_estudio.pdf','historias_academicas/historia-ezequiel-alessandro-acevedo-historia_academica.pdf','Interesado en las diversas ciencias de la computación','Enseñanza fluida y dinámica.','2019-08-11',NULL,NULL,'','El alumno posee los dotes necesarios para abocar su rubro a la investigación y enseñanza de las diversas ciencias de la computación.',1,'','',0,11,6);
INSERT INTO "alumno_alumno" VALUES (7,3042601,'curriculums/curriculum-fernando-adaro-curriculum.pdf','planes_de_estudio/plan-fernando-adaro-plan_de_estudio.pdf','historias_academicas/historia-fernando-adaro-historia_academica.pdf','','','2019-08-11',NULL,0,'El alumno no llega al porcentaje de materias aprobadas','',0,'','',0,12,NULL);
INSERT INTO "alumno_alumno" VALUES (8,3017616,'curriculums/curriculum-gisella-daiana-alaniz-curriculum.pdf','planes_de_estudio/plan-gisella-daiana-alaniz-plan_de_estudio.pdf','historias_academicas/historia-gisella-daiana-alaniz-historia_academica.pdf','','','2019-08-11',NULL,NULL,'','',0,'','perfiles/perfil-gisella-daiana-alaniz-perfil.jpeg',0,13,NULL);
INSERT INTO "alumno_alumno" VALUES (9,3032516,'curriculums/curriculum-valentina-baglioni-curriculum.pdf','planes_de_estudio/plan-valentina-baglioni-plan_de_estudio.pdf','historias_academicas/historia-valentina-baglioni-historia_academica.pdf','','','2014-08-11',NULL,1,'','',0,'','',0,14,3);
INSERT INTO "alumno_alumno" VALUES (10,3007817,'curriculums/curriculum-johanna-celeste-bello-curriculum.pdf','planes_de_estudio/plan-johanna-celeste-bello-plan_de_estudio.pdf','historias_academicas/historia-johanna-celeste-bello-historia_academica.pdf','Aprender y perfeccionarme en desarrollo de software','resumir 50 hojas en 3.','2019-08-11',NULL,NULL,'','',0,'','',0,15,5);
INSERT INTO "alumno_alumno" VALUES (11,3004417,'curriculums/curriculum-tobias-facundo-burger-curriculum.pdf','planes_de_estudio/plan-tobias-facundo-burger-plan_de_estudio.pdf','historias_academicas/historia-tobias-facundo-burger-historia_academica.pdf','','','2019-08-11',NULL,NULL,'','',0,'','perfiles/perfil-tobias-facundo-burger-perfil.jpeg',0,16,1);
INSERT INTO "alumno_alumno" VALUES (12,3011215,'curriculums/curriculum-gianfranco-capodici-curriculum.pdf','planes_de_estudio/plan-gianfranco-capodici-plan_de_estudio.pdf','historias_academicas/historia-gianfranco-capodici-historia_academica.pdf','','','2019-08-11',NULL,NULL,'','',0,'','',0,17,4);
INSERT INTO "alumno_alumno" VALUES (13,3073604,'curriculums/curriculum-ema-noemi-ciavarelli-curriculum.pdf','planes_de_estudio/plan-ema-noemi-ciavarelli-plan_de_estudio.pdf','historias_academicas/historia-ema-noemi-ciavarelli-historia_academica.pdf','','','2019-08-11',NULL,0,'La alumna no posee el porcentaje de materias requerido.','',0,'','perfiles/perfil-ema-noemi-ciavarelli-perfil.jpeg',0,18,1);
INSERT INTO "alumno_alumno" VALUES (14,3064504,'curriculums/curriculum-ezequiel-oscar-gaggioli-curriculum.pdf','planes_de_estudio/plan-ezequiel-oscar-gaggioli-plan_de_estudio.pdf','historias_academicas/historia-ezequiel-oscar-gaggioli-historia_academica.pdf','Aprender programación front end','no tengo ninguna','2019-08-11',NULL,NULL,'','',0,'','',0,19,3);
INSERT INTO "alumno_alumno" VALUES (15,3034914,'curriculums/curriculum-atilio-raul-guzman-curriculum.pdf','planes_de_estudio/plan-atilio-raul-guzman-plan_de_estudio.pdf','historias_academicas/historia-atilio-raul-guzman-historia_academica.pdf','','','2001-08-11',NULL,1,'','Alumno con gran desempeño académico.',1,'','',0,20,4);
INSERT INTO "alumno_alumno" VALUES (16,3008317,'curriculums/curriculum-facundo-agustin-homola-curriculum.pdf','planes_de_estudio/plan-facundo-agustin-homola-plan_de_estudio.pdf','historias_academicas/historia-facundo-agustin-homola-historia_academica.pdf','','','2019-08-11',NULL,NULL,'','',0,'','perfiles/perfil-facundo-agustin-homola-perfil.jpeg',0,21,5);
INSERT INTO "alumno_alumno" VALUES (17,3023717,'curriculums/curriculum-daniel-eliezer-kwist-curriculum.pdf','planes_de_estudio/plan-daniel-eliezer-kwist-plan_de_estudio.pdf','historias_academicas/historia-daniel-eliezer-kwist-historia_academica.pdf','crear una red de hackers por medio de mi enseñanza','Hackeo la computadora del delivery','2017-08-11',NULL,1,'','Alumno con gran capacidad para organizar y dirigir proyectos.',1,'','perfiles/perfil-daniel-eliezer-kwist-perfil.jpeg',0,22,6);
INSERT INTO "alumno_alumno" VALUES (18,3015815,'curriculums/curriculum-alexey-kutalo-curriculum.pdf','planes_de_estudio/plan-alexey-kutalo-plan_de_estudio.pdf','historias_academicas/historia-alexey-kutalo-historia_academica.pdf','Aprender pyton','Planificador de proyectos extensos.','2019-08-11',NULL,0,'El alumno no posee el porcentaje de materias requerido.','',0,'','',0,23,NULL);
INSERT INTO "alumno_alumno" VALUES (19,3011414,'curriculums/curriculum-gianni-roman-lupi-casale-curriculum.pdf','planes_de_estudio/plan-gianni-roman-lupi-casale-plan_de_estudio.pdf','historias_academicas/historia-gianni-roman-lupi-casale-historia_academica.pdf','','','2011-08-11',NULL,NULL,'','',0,'','perfiles/perfil-gianni-roman-lupi-casale-perfil.jpeg',0,24,1);
INSERT INTO "alumno_alumno" VALUES (20,3021917,'curriculums/curriculum-tomas-bautista-maldocena-curriculum.pdf','planes_de_estudio/plan-tomas-bautista-maldocena-plan_de_estudio.pdf','historias_academicas/historia-tomas-bautista-maldocena-historia_academica.pdf','interesado en programación front end','no tengo ninguna','2019-08-11',NULL,NULL,'','',0,'','',0,25,3);
INSERT INTO "alumno_alumno" VALUES (21,3017708,'curriculums/curriculum-pedro-arturo-mas-bustos-curriculum.pdf','planes_de_estudio/plan-pedro-arturo-mas-bustos-plan_de_estudio.pdf','historias_academicas/historia-pedro-arturo-mas-bustos-historia_academica.pdf','','','2015-08-11',NULL,1,'','',0,'','perfiles/perfil-pedro-arturo-mas-bustos-perfil.jpeg',0,26,4);
INSERT INTO "alumno_alumno" VALUES (22,3028517,'curriculums/curriculum-leonela-sofia-oyarzun-curriculum.pdf','planes_de_estudio/plan-leonela-sofia-oyarzun-plan_de_estudio.pdf','historias_academicas/historia-leonela-sofia-oyarzun-historia_academica.pdf','Interesada en lenguaje C++','nivel de programación C avanzado.','2019-08-11',NULL,0,'La alumna no posee el porcentaje de materias requerido','',0,'','perfiles/perfil-leonela-sofia-oyarzun-perfil.jpeg',0,27,5);
INSERT INTO "alumno_alumno" VALUES (23,3016209,'curriculums/curriculum-juan-alejandro-palma-curriculum.pdf','planes_de_estudio/plan-juan-alejandro-palma-plan_de_estudio.pdf','historias_academicas/historia-juan-alejandro-palma-historia_academica.pdf','Enseñanza didáctica de ciencias modernas','Aprendo rápido','2015-08-11',NULL,1,'','',0,'','perfiles/perfil-juan-alejandro-palma-perfil.jpeg',0,28,6);
INSERT INTO "alumno_alumno" VALUES (24,3032416,'curriculums/curriculum-florencia-azul-parnisari-curriculum.pdf','planes_de_estudio/plan-florencia-azul-parnisari-plan_de_estudio.pdf','historias_academicas/historia-florencia-azul-parnisari-historia_academica.pdf','','','2019-08-11',NULL,NULL,'','Alumno persistente y responsable.',1,'','perfiles/perfil-florencia-azul-parnisari-perfil.jpeg',0,29,1);
...
INSERT INTO "alumno_alumno" VALUES (27,3037110,'curriculums/curriculum-maria-silvia-sofia-saieg-curriculum.pdf','planes_de_estudio/plan-maria-silvia-sofia-saieg-plan_de_estudio.pdf','historias_academicas/historia-maria-silvia-sofia-saieg-historia_academica.pdf','','','2019-08-11',NULL,NULL,'','',0,'','',0,32,6);
...
INSERT INTO "alumno_alumno" VALUES (29,3019916,'curriculums/curriculum-leandro-troncoso-curriculum.pdf','planes_de_estudio/plan-leandro-troncoso-plan_de_estudio.pdf','historias_academicas/historia-leandro-troncoso-historia_academica.pdf','','','2019-08-11',NULL,NULL,'','',0,'','',0,34,1);
INSERT INTO "alumno_carrera" VALUES (1,'Tecnicatura Universitaria en Redes de Computadoras',1,1);
INSERT INTO "alumno_carrera" VALUES (3,'Tecnicatura Universitaria en Web',1,1);
INSERT INTO "alumno_carrera" VALUES (4,'Ingeniería en Computación',1,1);
INSERT INTO "alumno_carrera" VALUES (5,'Licenciatura en Ciencias de la Computación',1,1);
INSERT INTO "alumno_carrera" VALUES (6,'Profesorado en Ciencias de la Computación',1,1);
INSERT INTO "alumno_carrera" VALUES (10,'Ingenieria en Informatica',1,1);
...
INSERT INTO "alumno_subcomisioncarrera_docentes" VALUES (23,10,'docente4@asd.com');
INSERT INTO "alumno_subcomisioncarrera_docentes" VALUES (24,10,'docente28@asd.com');
...
INSERT INTO "alumno_subcomisioncarrera" VALUES (10,10,56);
...
INSERT INTO "alumno_user" VALUES (1,'pbkdf2_sha256$150000$HA1Sudv6FWhC$tNQVnLre8O/Tyn01hPJvdvWmlGiwQpTfBUaO3aLX7RU=','2019-08-24 00:47:06.821158',1,'admin','','','admin@admin.com',1,1,'2019-08-04 18:06:15.266537-03','AL');
...
INSERT INTO "alumno_user" VALUES (4,'pbkdf2_sha256$150000$DVYUbWQPXO7v$zPVshYqDUd9jCymLvAQONCmYTDzlCYO3jeEwWhHeN6g=','2019-08-23 22:02:16.321469',0,'com-pas','Comisión de Pasantías del','1','com@asd.com',0,1,'2019-08-04 21:44:31.409063','CP');
...
INSERT INTO "alumno_user" VALUES (56,'pbkdf2_sha256$150000$CDjKCh8xvjil$WaFqwKqfMyr3uIRdfUS5cvVpmxvlmpJfT0NWA9Ra75s=',NULL,0,'ing-inf-2','otra','ing','inginf2@asd.com',0,1,'2019-08-24 02:30:04.685261','AL');
