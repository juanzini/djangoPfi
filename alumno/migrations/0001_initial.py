# Generated by Django 2.1 on 2018-10-14 21:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tutor_docente', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='alumno.Docente')),
            ],
        ),
        migrations.CreateModel(
            name='Postulaciones',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_link', models.OneToOneField(db_column='id', on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'user',
                'verbose_name_plural': 'users',
