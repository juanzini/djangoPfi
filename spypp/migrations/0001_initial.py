# Generated by Django 2.2.1 on 2019-09-01 22:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('perfil', private_storage.fields.PrivateFileField(blank=True, null=True, storage=private_storage.storage.files.PrivateFileSystemStorage(), upload_to=spypp.models.Alumno.perfil_upload_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tutor_empresa', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='spypp.TutorEmpresa')),
            ],
            options={
