...
urlpatterns = [
    ...
    path('empresa/entrevista/nueva', login_required(permissions(views.CreateEntrevistaView.as_view(), User.EM)),
         name='nueva-entrevista-empresa'),
    path('empresa/entrevista/regenerar', login_required(permissions(views.CreateEntrevistaView.as_view(), User.EM)),
    ...
    path('comision_pasantias/postulaciones/<pk>',
         login_required(permissions(views.DetailPostulacionComisionPasantiasView.as_view(), User.CP)),
         name='postulacion-detail-comision-pasantias'),
